...
class DesistementFilterType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->add('date_debut','filter_date',array(
                ...
                $filterBuilder->andWhere('d.date_desistement >= \''.$values['value']->format('Y-m-d').'\'' );
    ...
    {
        return 'amb_adherentbundle_desistementfiltertype';
    }
}
